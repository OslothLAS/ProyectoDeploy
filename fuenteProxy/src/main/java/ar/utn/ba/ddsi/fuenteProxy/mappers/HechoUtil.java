...
import ar.utn.ba.ddsi.fuenteProxy.dtos.hecho.*;
import ar.utn.ba.ddsi.fuenteProxy.models.entities.hechos.*;
...
public class HechoUtil {
    public static HechoOutputDTO hechoToDTO(Hecho hecho) {
        ...
        dto.setEsConsensuado(hecho.getEsConsensuado());
    ...
    public static Hecho hechoDTOtoHecho(HechoOutputDTO dto){
        ...
        return new Hecho(null, dto.getTitulo(), dto.getDescripcion(),cat,ubi,dto.getFechaHecho(),dto.getHandles(),
                multimediaNueva,dto.getOrigen(),dto.getFuenteOrigen(),dto.getFechaCreacion(),dto.getEsValido(),dto.getEsConsensuado());
    }
